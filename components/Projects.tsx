...
// import { Shield, Network, Server, ArrowUpRight, CheckCircle2 } from "lucide-react";
import { Shield, Network, Server, ArrowUpRight, CheckCircle2, Layers, Cpu, Activity } from "lucide-react";

export default function Projects() {
    // Updates the icon and badge color assignment dynamically inside src/components/Projects.tsx
    const getCategoryIcon = (category: string) => {
        switch (category) {

            case "MikroTik Core Operations":
                return <Activity className="text-teal-500" size={20} />; // Uses a vibrant teal color accent
            case "Cyber Security":
            ...
            case "L2 Data Link Layer":
                return <Layers className="text-amber-500" size={20} />; // Make sure to import Layers from 'lucide-react'
            case "L3 Network Layer":
                return <Cpu className="text-orange-500" size={20} />;    // Make sure to import Cpu from 'lucide-react'
            case "L4 Transport Layer":
                return <Activity className="text-rose-500" size={20} />; // Make sure to import Activity from 'lucide-react'
            default:
